package com.example.angelchanquin.widgetsavanzados;
...
public class MiWidget extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent){
        ...
        if(intent.getAction().equals("com.example.angelchanquin.widgetsavanzados.ACTUALIZAR_WIDGET")){
    ...
    public static void actualizarWidget(Context context, AppWidgetManager appWidgetManager, int widgetId){
        ...
        Intent intent = new Intent("com.example.angelchanquin.widgetsavanzados.ACTUALIZAR_WIDGET");
