...
import com.example.angelchanquin.contentproviders.helpers.ClientesSqliteHelper;
...
public class ClientesProvider extends ContentProvider {
    ...
    private static final String URI = "content://com.example.angelchanquin.contentproviders/clientes/";
    ...
    static {
        ...
        uriMatcher.addURI("com.example.angelchanquin.contentproviders", "clientes", CLIENTES);
        uriMatcher.addURI("com.example.angelchanquin.contentproviders", "clientes/#", CLIENTES_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match){
            case CLIENTES:
                return "com.android.cursor.dir/com.angelchanquin.cliente";
            case CLIENTES_ID:
                return "com.android.cursor.item/com.angelchanquin.cliente";
            default:
                return null;
        }
    }
